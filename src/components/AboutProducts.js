    ...
    return <section className="container">
        <div className="info">
            ...
            <p className="text-14">Petrykivka painting (or simply "Petrykivka"; Ukrainian: Петриківський розпис ) is a traditional Ukrainian decorative painting style, originating from the village of Petrykivka in Dnipropetrovsk oblast of Ukraine, where it was traditionally used to decorate house walls and everyday household items. The earliest known examples of this style date from the 18th century, but it continues to thrive and develop as a modern art form.
                ...
                In 2012, the Ministry of Culture of Ukraine recognized Petrykivka painting as a part of the intangible cultural heritage of Ukraine, and it was included in the UNESCO Representative List of the Intangible Cultural Heritage of Humanity in 2013. Petrykivka painting has become a "brand" in Ukrainian popular culture, and a "Petrykivka" trademark belonging to the artisans of Petrykivka village has been created.</p>
            <p className="text-14">Products in our handmade shop. You can order a drawing according to your design. But then consider the time for the work of the master. Phone:123-456-789 :) </p></div>
    </section>;
}
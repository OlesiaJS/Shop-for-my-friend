...
export default function AboutProducts() {
    return <section className="container">
        <div className="info">
            ...
            <p className="text-14">Products in our handmade shop. You can order a drawing according to your design. But then consider the time for the work of the master. </p></div>
    </section>;
}